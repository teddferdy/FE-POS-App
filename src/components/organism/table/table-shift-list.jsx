...
const TableShiftList = ({ allShift, handleDelete, pagination, setPagination }) => {
    ...
    <Fragment>
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-4 py-4">
        ...
        <div className="flex items-center gap-2 flex-1 justify-end">
          ...
          <span>
            Page {pagination.page} of {allShift?.data?.pagination?.totalPages}
          </span>
          <Button
            variant="outline"
            size="sm"
            onClick={() => setPagination((prev) => ({ ...prev, page: prev.page + 1 }))}
            disabled={pagination.page === allShift?.data?.pagination?.totalPages}>
            Next
          </Button>
        </div>
      </div>
