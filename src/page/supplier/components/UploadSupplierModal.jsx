...
const UploadSupplierModal = ({ open, onOpenChange, onUploadSuccess }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await uploadSupplierExcel(file);
      setUploadStatus("success");
      toast.success(t("common.success"), {
        description: res.message || t("page.supplier.toast.uploadSuccess")
      });
      setTimeout(() => {
        handleClose();
...
UploadSupplierModal.propTypes = {
  open: PropTypes.bool.isRequired,
  onOpenChange: PropTypes.func.isRequired,
  onUploadSuccess: PropTypes.func
};

export default UploadSupplierModal;
