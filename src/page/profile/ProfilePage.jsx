        ...
        <div className="col-span-12 lg:col-span-4 space-y-6">
          <div className="bg-card rounded-xl shadow-sm border border-border p-5">
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Gender</p>
        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          <div className="bg-card rounded-xl shadow-sm border border-border p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Employee ID</p>
                <p className="text-sm font-mono font-bold text-primary">{user.employeeID || "-"}</p>
              </div>
              <div>
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Position</p>
                <p className="text-sm text-foreground">{user.positionName || user.position || "-"}</p>
              </div>
              <div>
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Store</p>
                <p className="text-sm text-foreground">{user.storeName || "-"}</p>
              </div>
              <div>
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Employment Type</p>
                <p className="text-sm text-foreground">{user.employmentType || "-"}</p>
              </div>
              <div>
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Shift</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-card rounded-xl shadow-sm border border-border p-4 relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-lg font-bold text-foreground">{formatDate(user.dateOfBirth)}</p>
              </div>
            ...
            <div className="bg-card rounded-xl shadow-sm border border-border p-4 relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className={`text-lg font-bold flex items-center gap-1 ${statusActive ? "text-green-600" : "text-red-600"}`}>
