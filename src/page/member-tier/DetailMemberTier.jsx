...
const DetailMemberTier = () => {
  ...
  const { data: tierData, isLoading } = useQuery(
    ["member-tier-detail", tierId],
    () => getDetailMemberTier(tierId),
    { enabled: !!tierId }
  );
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-border">
          ...
          <div className="p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Diskon</p>
              <p className="text-sm font-semibold text-foreground mt-0.5">
      ...
      <div className="flex justify-end gap-3">
        ...
        <Button onClick={() => navigate(`/edit-member-tier?id=${tier.id}`)} className="gap-2 shadow-md">
