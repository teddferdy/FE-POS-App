  ...
  const updateMutation = useMutation((payload) => updateBundle(id, payload), {
    onSuccess: () => {
      toast.success(t("common.success"), {
        description: t("page.bundle.updateSuccess")
      });
      ...
      <div className="space-y-6">
        <div>
          <nav className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span className="text-primary font-semibold">{t("page.bundle.editTitle")}</span>
          </nav>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <Card className="p-6">
              <h3 className="font-semibold text-sm mb-4">{t("page.bundle.form.generalInfo")}</h3>
            ...
            <Card className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-sm">{t("page.bundle.form.items")} *</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <Button
                ...
                disabled={updateMutation.isLoading || !formData.name}>
                <Save size={16} className="mr-2" />
                {updateMutation.isLoading ? t("common.processing") : t("common.save")}
              </Button>
            </div>
          </div>
        </div>
